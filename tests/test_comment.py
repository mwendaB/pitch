...
class commentTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    '''    
    self.new_pitch=Pitch(category='lifestyle',p_title='Life is great',pitch_it='Life is good enjoy it to tha fullest',post='saturday',posted_by='mwenda',upvote=20,downvote=10)
    self.new_comment=Comment(id=1,p_comment='Nice work',post_com=2019-3-12,comment_by='mwenda',pitch_id=4,PITCHID=4)
  def tearDown(self):
    '''
  ...
  def test_check_instanse(self):
    ...
    self.assertEquals(self.new_comment.comment_by,'mwenda')
